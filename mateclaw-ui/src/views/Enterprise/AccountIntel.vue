...
const accounts: Account[] = [
  {
    ...
    region: 'North America · San Francisco',
    stage: 'negotiation',
    aum: '$1.7M / year',
    score: 82,
    scoreDelta: '+8 (this week)',
    color: 'linear-gradient(135deg, #d96d46, #ebb08f)',
    people: [
      { name: 'Dr. Emily Chen', role: 'CTO (newly appointed)', kind: 'decider', short: 'E' },
      { name: 'Marcus Lee', role: 'VP Engineering', kind: 'influencer', short: 'M' },
      { name: 'Alex Zhang', role: 'Senior Architect', kind: 'user', short: 'A' },
      { name: 'Janet Wu', role: 'Procurement', kind: 'procurement', short: 'J' },
    ],
    events: [
      { id: 'e1', kind: 'hiring', summary: 'Acme is recruiting four Privacy Counsel roles on LinkedIn, indicating faster compliance investment.', source: 'LinkedIn signal · Automated capture', at: '6 hours ago' },
      { id: 'e2', kind: 'news', summary: 'At Acme’s quarterly meeting, the CEO said all infrastructure would move to the cloud in H1 2026.', source: 'Official quarterly report · Page 4', at: 'Today, 10:30' },
      { id: 'e3', kind: 'meeting', summary: 'Second call with Dr. Chen: the CTO explicitly asked about data residency and private deployment.', source: 'Meeting notes · Sales record', at: 'Yesterday, 16:00' },
      { id: 'e4', kind: 'competitor', summary: 'A Zerto proof-of-concept appeared in Acme’s procurement system and requires close attention.', source: 'Competitive signal · Crunchbase', at: '2 days ago' },
      { id: 'e5', kind: 'doc', summary: 'Acme’s 2025 architecture white paper was uploaded internally; analysis found seven entry points.', source: 'Customer repository · Acme.pdf', at: '2 days ago' },
      { id: 'e6', kind: 'funding', summary: 'Acme closed an $80M Series D and plans to expand into Europe.', source: 'TechCrunch · Report', at: 'Last week' },
    ],
    actions: [
      { priority: 'high',   when: 'Today', title: 'Send the private-deployment PDF to Dr. Chen', rationale: 'Dr. Chen raised data residency in the latest meeting, and the follow-up is still outstanding.' },
      { priority: 'high',   when: 'This week', title: 'Schedule a technical review with Marcus Lee', rationale: 'The VP of Engineering is a key influencer, and the Zerto POC signal narrows the window.' },
      { priority: 'medium', when: 'This week', title: 'Map Acme’s case to the BlueWave rollout', rationale: 'A peer e-commerce SaaS company has a similar scale and makes a useful case study.' },
      { priority: 'low',    when: 'Next week', title: 'Publish a thought-leadership response to Acme’s cloud signal', rationale: 'Content marketing can amplify this opportunity signal.' },
    ],
  },
  {
    id: 'bluewave',

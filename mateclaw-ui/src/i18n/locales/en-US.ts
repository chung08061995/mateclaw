export default {
  ...
  chat: {
    ...
    providerQuota: {
      ...
      account: 'Account',
      chipKnown: 'Provider quota {percent}% used',
      chipUnknown: 'Provider quota unavailable',
      chipRateLimited: 'Provider temporarily rate limited',
      chipExhausted: 'Provider quota appears exhausted',
      mostRecent: 'Most recently successful account',
      unavailable: 'Usage unavailable',
      rateLimited: 'Temporarily rate limited',
      exhausted: 'Quota appears exhausted',
      reset: 'Reset reported',
      lastObserved: 'Last observed',
      freshnessHint: 'Based on the latest provider quota headers observed by MateClaw.',
      details: 'Open Provider Usage',
    },
    usageDetail: {
  ...
  providerUsage: {
    kicker: 'Provider Pool',
    title: 'Provider Usage',
    desc: 'See which account is in use, track MateClaw token consumption, and keep backup OpenAI, Claude, and Gemini credentials ready for failover.',
    addAccount: 'Add account',
    editAccount: 'Edit account',
    refresh: 'Refresh',
    refreshing: 'Refreshing…',
    currentAccount: 'Currently in use',
    noActiveAccount: 'No account is currently active',
    totalAccounts: 'Accounts in pool',
    totalTokens: 'MateClaw tokens',
    alerts: 'Accounts needing attention',
    active: 'In use',
    backup: 'Backup',
    disabled: 'Disabled',
    enabled: 'Enabled',
    unknownAccount: 'Unlabelled account',
    unknownProvider: 'Unknown provider',
    unknownStatus: 'Status unknown',
    status: 'Status',
    quota: 'Provider quota',
    quotaUnknown: 'Quota unavailable',
    quotaUnknownHint: 'This provider does not expose a reliable remaining-quota value. MateClaw will still show rate-limit and exhaustion signals when they occur.',
    quotaUsed: '{percent}% used',
    quotaReset: 'Resets on {time}',
    quotaResetUnknown: 'Reset time unavailable',
    quotaUpdated: 'Checked on {time}',
    quotaSource: 'Source: {source}',
    usage: 'MateClaw usage',
    promptTokens: 'Prompt',
    completionTokens: 'Completion',
    lastUsed: 'Last used on {time}',
    neverUsed: 'Not used yet',
    timeUnavailable: 'Time unavailable',
    usageLimitReachedTitle: 'Usage limit reached',
    usageLimitReachedMessage: 'OpenAI confirmed that this account has reached its usage limit. MateClaw will try it again after the reset time shown above.',
    providerErrorTitle: 'Provider error',
    providerErrorMessage: 'The provider reported an error without additional details.',
    accountId: 'Provider account',
    authType: 'Credential',
    priority: 'Priority {priority}',
    warningTitle: '{count} provider account needs attention',
    warningDesc: 'Move a healthy backup higher in the pool or reconnect the affected credential before requests begin failing.',
    critical: 'Quota exhausted',
    warning: 'Near limit',
    healthy: 'Available',
    emptyTitle: 'No provider accounts in the pool',
    emptyDesc: 'Add OpenAI, Claude, or Gemini credentials. MateClaw can move to the next enabled account when one becomes unavailable.',
    loading: 'Loading provider usage…',
    loadFailed: 'Failed to load provider usage',
    saveFailed: 'Failed to save provider account',
    actionFailed: 'Provider account action failed',
    saved: 'Provider account saved',
    deleted: 'Provider account deleted',
    reordered: 'Provider priority updated',
    enable: 'Enable',
    disable: 'Disable',
    edit: 'Edit',
    remove: 'Remove',
    moveUp: 'Move up',
    moveDown: 'Move down',
    deleteTitle: 'Remove provider account?',
    deleteConfirm: 'Remove “{label}” from the provider pool? Existing usage history will remain, but this credential will no longer be available for failover.',
    addTitle: 'Add provider account',
    editTitle: 'Edit provider account',
    formIntro: 'Each account is an independent pool entry. Add more than one credential for the same provider to create a fallback chain.',
    provider: 'Provider and credential type',
    providerPlaceholder: 'Choose a provider account type',
    label: 'Account label',
    labelPlaceholder: 'e.g. OpenAI work account',
    apiKey: 'API key',
    apiKeyPlaceholder: 'Paste the credential securely',
    apiKeyKeep: 'Leave blank to keep the existing key.',
    oauthHint: 'A provider sign-in window will open. Each successful OpenAI or Claude login is stored as a separate pool account; you can rename it here afterward.',
    oauthLaunch: 'Continue to provider sign-in',
    ...
    saving: 'Saving…',
    credentialTypes: {
      openaiOauth: 'OpenAI — ChatGPT/Codex login',
      openaiApi: 'OpenAI — API key',
      claudeOauth: 'Claude — Claude Code login',
      claudeApi: 'Claude — Anthropic API key',
      geminiApi: 'Gemini — Google AI API key',
    },
  },
  acp: {
